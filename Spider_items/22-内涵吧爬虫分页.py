...
class NeiHanDuanZiSpider(object):
    ...
    def __init__(self):
        ...
        self.pre_url = "http://www.neihanpa.com/article/"
    ...
    def run(self):
        ...
        while url is not None:
            ...
            # 2.分析数据,提取需要的内容
            dz_list, url = self.get_data_from_page(page)
            # 3.保存数据
